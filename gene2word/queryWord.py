...
def getHTMLfromTree(t, c):
    ...
    if len(t[0]) == 1 and len(t[1]) == 1:
        if random.random() > 0.7:
            return (
                '<table border = "1"><tr><td style="background-color:'
                + color
                + '">'
                + '<p style="font-size:'
                + t[0][0][1]
                + 'px">'
                + t[0][0][0]
                + '</p></td><td style="background-color:'
                + color
                + '">'
            ...
            return (
                ...
                + 'px">'
                + t[0][0][0]
                + '</p></td></tr><tr><td style="background-color:'
                + color
                + '">'
                + '<p style="font-size:'
                + t[1][0][1]
        ...
        if random.random() > 0.7:
            ...
            return (
                ...
                + '">'
                + getHTMLfromTree(t[0], c - 8)
                + '</td></tr><tr><td style="background-color:'
                + color
                + '">'
                + '<p style="font-size:'
                + t[1][0][1]
